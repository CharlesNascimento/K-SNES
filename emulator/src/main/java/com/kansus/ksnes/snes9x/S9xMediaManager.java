...
public class S9xMediaManager {
    ...
    public static void setOnFrameDrawnListener(Emulator.OnFrameDrawnListener frameDrawnListener) {
        onFrameDrawnListener = frameDrawnListener;
    }

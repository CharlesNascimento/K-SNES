...
static jboolean
S9xEmulator_loadEngine(JNIEnv *env, jobject self, jstring jdir, jstring jlib)
{
...
static jboolean
S9xEmulator_initialize(JNIEnv *env, jobject self, jstring jdir, jint sdk)
{
	...
	jclass clazz = env->FindClass(
			"com/kansus/ksnes/abstractemulator/Emulator$FrameUpdateListener");
...
int register_Emulator(JNIEnv *env)
{
	static const JNINativeMethod methods[] = {
		{ "setFrameUpdateListener",
				"(Lcom/kansus/ksnes/abstractemulator/Emulator$FrameUpdateListener;)V",
...
int register_Cheats(JNIEnv *env)
{
	...
	return jniRegisterNativeMethods(env, "com/kansus/ksnes/snes9x/S9xCheatManager",
			methods, NELEM(methods));
}
